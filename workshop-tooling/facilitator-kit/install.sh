...
step_populate_workshop() {
    ...
    # Ensure Python scripts are executable for the user
    chmod 755 "${workshop_dir}/tools/build-injected.py" \
              "${workshop_dir}/tools/recover-baseline.py"
}

# ---------------------------------------------------------------------------
# Step 5: smoke-test — exercise the two Python tools' self-test modes
